...
impl CPU {
    pub(in super::super) fn op_sub_ri(&mut self, memory: &mut Memory) -> ops::Result {
        ...
        if self.opts.print_op {
            println!("{:03}\tSUB  r{}, {}", self.meta.steps, r0, imm4);
        }
...
mod tests {
    ...
    fn test_sub_ri() {
        ...
        let _ = memory.set_bytes(0, &[
            Op::SubRI.bytecode(), 0x00, 0x00, 0x00, 0x00, 0x01,
        ]);
